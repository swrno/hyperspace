...
import {
  ...
  CheckCircle2, Loader2, FolderPlus, Search, FileStack, Calendar,
} from 'lucide-react';
...
export default function KnowledgeBases({ idToken, onAsk }) {
  ...
  const onFiles = async (kbId, fileList) => {
